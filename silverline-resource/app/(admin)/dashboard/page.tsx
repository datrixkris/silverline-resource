...
import { Users, FolderKanban, FileText, TrendingUp, ArrowUpRight, ArrowDownRight } from "lucide-react"
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Content creation and engagement metrics for the last 30 days.</CardDescription>
              </CardHeader>
            ...
            <Card className="col-span-3">
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { user: "John Doe", action: "created a new blog post", time: "2 hours ago" },
                    { user: "Jane Smith", action: "updated project details", time: "5 hours ago" },
                    { user: "Mike Johnson", action: "added a new user", time: "1 day ago" },
                    { user: "Sarah Williams", action: "published a blog post", time: "2 days ago" },
                    { user: "Alex Brown", action: "updated user permissions", time: "3 days ago" },
                  ].map((item, i) => (
